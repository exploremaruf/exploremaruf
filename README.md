...
I am an Android developer from Bangladesh.

## About Me

- I build Android applications.
- I work with Java and Kotlin.
- I am currently learning Jetpack Compose and Kotlin design patterns.
- I am interested in clean architecture, open source, and hardware projects with Arduino.

## Tech Stack

- **Languages:** Java, Kotlin, HTML, CSS
- **Mobile Development:** Android, Android Studio, Jetpack Compose
- **Tools and Platforms:** Git, GitHub, VS Code, Linux, Figma, Arduino
